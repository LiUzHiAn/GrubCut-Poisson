...
// captype: type of edge capacities (excluding t-links)  相邻边权值的类型
// tcaptype: type of t-links (edges between nodes and terminals) t-links的权值类型
...
public:
	typedef enum
	{
		SOURCE	= 0,
		SINK	= 1
	} termtype; // terminals  0-代表目标，1-代表背景
	typedef int node_id;
